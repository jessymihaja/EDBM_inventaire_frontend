...
const ListeDemandeSuspendus = () =>{
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            const response = await axios.get<DemandeDetention[]>(BASE_URL+`demandeDetentionByEtatDemande/${1}`);
...
export default ListeDemandeSuspendus;