...
export interface DemandeDetention {
    id: number;
    idemploye: string;
    etatdemande: number;
...
interface DemandeDetentionCardProps {
    demande: DemandeDetention;
    onTraiter: (id: number,etat:number) => void;
...
const DemandeDetentionCard: React.FC<DemandeDetentionCardProps> = ({ demande, onTraiter, onSuspendre,boutonTraiter,boutonSuspendre,etat1,etat2 }) => {
    ...
    return (
        <Card className="mb-3">
            ...
            <Card.Body>
                ...
                <div className="mt-3">
                    <Button variant="success" onClick={() => onTraiter(demande.id,etat1)}>{boutonTraiter}</Button>{' '}
...
export default DemandeDetentionCard;
